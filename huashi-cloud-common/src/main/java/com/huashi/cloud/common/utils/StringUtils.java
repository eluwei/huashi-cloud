...
public final class StringUtils {
    ...
    // 组织机构最顶层为初唐
    public static final Integer ORGTOP = 1;
    ...
    public static boolean isNullOrEmpty(Object object) {
        return object == null || object.toString().trim().equals(EMPTY);
    }
    ...
    public static boolean isNotNullAndEmpty(Object object) {
        return !StringUtils.isNullOrEmpty(object);
    }
    /**
     ...
     * @date 2018/5/7 14:13
     * @version V1.0.0
     * @description 简单编码URL(用于处理图片路径中的中文和空格字符)
     */
